...
class Document implements RessourceInterface
{
    ...
    public const string TYPE_ID_CARD = "ID";            // Carte d'identité
    public const string TYPE_PASSPORT = "PASS";         // Passeport
    public const string TYPE_PASSPORT_PHOTO = "PHOTO";  // Photo passeport
    public const string TYPE_SIGNATURE = "SIGN";        // Signature électronique

    // Documents personnels
    public const string TYPE_BIRTH_CERTIFICATE = "BIRTH";   // Acte de naissance
    public const string TYPE_MARITAL_STATUS = "MARST";      // Document état civil
    public const string TYPE_RESIDENCE_PROOF = "ADDR";      // Attestation de résidence

    // Documents académiques
    public const string TYPE_DIPLOMA = "DIPL";          // Diplôme
    public const string TYPE_CERTIFICATE = "CERT";      // Certificat professionnel
    public const string TYPE_CV = "CV";                 // Curriculum vitae

    // Documents RH
    public const string TYPE_CONTRACT = "CNTR";         // Contrat de travail
    public const string TYPE_CONTRACT_AMENDMENT = "AMD"; // Avenant contrat
    public const string TYPE_JOB_OFFER = "JOFF";        // Offre d'emploi
    public const string TYPE_APPOINTMENT_LETTER = "APPT"; // Lettre de nomination

    // Documents administratifs
    public const string TYPE_ATTESTATION = "ATST";      // Attestation de travail
    public const string TYPE_MISSION_ORDER = "MISS";    // Ordre de mission
    public const string TYPE_WARNING_LETTER = "WARN";   // Lettre d'avertissement

    // Paie et finance
    public const string TYPE_PAYSLIP = "PAY";           // Fiche de paie
    public const string TYPE_TAX_DOCUMENT = "TAX";      // Document fiscal
    public const string TYPE_BANK_DETAILS = "BANK";     // Coordonnées bancaires

    // Assurance
    public const string TYPE_INSURANCE_CERTIFICATE = "INS"; // Assurance
    public const string TYPE_MEDICAL_CERTIFICATE = "MED";   // Certificat médical

    // Fin de contrat
    public const string TYPE_RESIGNATION_LETTER = "RES"; // Lettre de démission
    public const string TYPE_TERMINATION_DOCUMENT = "TERM"; // Document fin contrat
    public const string TYPE_EXIT_CLEARANCE = "EXIT"; // Fiche sortie employé

    // Divers
    public const string TYPE_LEGAL_DOCUMENT = "LEGAL";
    ...
    {
        return [
            "Carte d'identité" => self::TYPE_ID_CARD,
            "Passeport" => self::TYPE_PASSPORT,
            "Photo passeport" => self::TYPE_PASSPORT_PHOTO,
            "Signature électronique" => self::TYPE_SIGNATURE,
            "Acte de naissance" => self::TYPE_BIRTH_CERTIFICATE,
            "Document état civil" => self::TYPE_MARITAL_STATUS,
            "Attestation de résidence" => self::TYPE_RESIDENCE_PROOF,
            "Diplôme" => self::TYPE_DIPLOMA,
            "Certificat professionnel" => self::TYPE_CERTIFICATE,
            "Curriculum vitae" => self::TYPE_CV,
            "Contrat de travail" => self::TYPE_CONTRACT,
            "Avenant contrat" => self::TYPE_CONTRACT_AMENDMENT,
            "Offre d'emploi" => self::TYPE_JOB_OFFER,
            "Lettre de nomination" => self::TYPE_APPOINTMENT_LETTER,
            "Attestation de travail" => self::TYPE_ATTESTATION,
            "Ordre de mission" => self::TYPE_MISSION_ORDER,
            "Lettre d'avertissement" => self::TYPE_WARNING_LETTER,
            "Fiche de paie" => self::TYPE_PAYSLIP,
            "Document fiscal" => self::TYPE_TAX_DOCUMENT,
            "Coordonnées bancaires" => self::TYPE_BANK_DETAILS,
            "Assurance" => self::TYPE_INSURANCE_CERTIFICATE,
            "Certificat médical" => self::TYPE_MEDICAL_CERTIFICATE,
            "Lettre de démission" => self::TYPE_RESIGNATION_LETTER,
            "Document fin contrat" => self::TYPE_TERMINATION_DOCUMENT,
            "Fiche sortie employé" => self::TYPE_EXIT_CLEARANCE,
